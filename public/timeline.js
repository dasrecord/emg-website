...
;(() => {
      ...
      856: function (t) {
        t.exports = (function () {
          ...
          return (function t() {
            ...
            var mt = {}
            i.isSupported =
              'function' == typeof it && rt && void 0 !== rt.createHTMLDocument && 9 !== ut
            var _t = z,
              pt = P,
              ft = H,
              gt = q,
              ...
              Vt = function (t) {
                ;(Gt && Gt === t) ||
                  ((t && 'object' === (void 0 === t ? 'undefined' : U(t))) || (t = {}),
                  (t = T(t)),
                  (wt = 'ALLOWED_TAGS' in t ? x({}, t.ALLOWED_TAGS) : kt),
                  (xt = 'ALLOWED_ATTR' in t ? x({}, t.ALLOWED_ATTR) : Tt),
                  (Wt = 'ADD_URI_SAFE_ATTR' in t ? x(T(Zt), t.ADD_URI_SAFE_ATTR) : Zt),
                  (Bt = 'ADD_DATA_URI_TAGS' in t ? x(T(Ut), t.ADD_DATA_URI_TAGS) : Ut),
            ...
            var te = 'http://www.w3.org/1998/Math/MathML',
              ...
              oe = function (t) {
                ...
                return (
                  t && i && e.body.insertBefore(s.createTextNode(i), e.body.childNodes[0] || null),
              ...
              ce = function (t) {
                ...
                var a = p(t.nodeName)
                if (
                  (de('uponSanitizeElement', t, { tagName: a, allowedTags: wt }),
                ...
                return t instanceof h && !ae(t)
                  ? (se(t), !0)
                  : ('noscript' !== a && 'noembed' !== a) || !b(/<\/no(script|embed)/i, t.innerHTML)
                  ? (At &&
                      3 === t.nodeType &&
                      ((e = t.textContent),
                      (e = g(e, _t, ' ')),
                      (e = g(e, pt, ' ')),
                      t.textContent !== e &&
                        (_(i.removed, { element: t.cloneNode() }), (t.textContent = e))),
              ...
              me = function (t) {
                ...
                var o = t.attributes
                if (o) {
                  var r = { attrName: '', attrValue: '', keepAttr: !0, allowedAttributes: xt }
                  for (n = o.length; n--; ) {
                    var l = (e = o[n]),
                      h = l.name,
                      d = l.namespaceURI
              ...
              _e = function t(e) {
                var i = void 0,
                  a = re(e)
                for (de('beforeSanitizeShadowDOM', e, null); (i = a.nextNode()); )
            ...
            return (
              (i.sanitize = function (t, s) {
                ...
                if ((It || Vt(s), (i.removed = []), 'string' == typeof t && (qt = !1), qt));
                  ...
                  (1 === (r = (n = oe('\x3c!----\x3e')).ownerDocument.importNode(t, !0)).nodeType &&
                    'BODY' === r.nodeName) ||
                  'HTML' === r.nodeName
                    ? (n = r)
                    : n.appendChild(r)
                ...
                return (
                  At && ((m = g(m, _t, ' ')), (m = g(m, pt, ' '))), st && zt ? st.createHTML(m) : m
                )
              }),
                  ...
                  t(n, [
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        t.contains(i) &&
                          (i.blur(), i === document.activeElement && document.body.focus())
                      }
                    },
                    {
                      key: '_visitNode',
                          ...
                          if (a.call(t, s)) {
                            ...
                            t.hasAttribute('tabindex') && (this._savedTabIndex = t.tabIndex),
                              ...
                              t.nodeType === Node.ELEMENT_NODE &&
                                ((t.focus = function () {}), (this._overrodeFocusMethod = !0))
                          } else
                            t.hasAttribute('tabindex') &&
                              ((this._savedTabIndex = t.tabIndex), t.removeAttribute('tabindex'))
                        }
                      }
                    },
                    {
                  ...
                  t(s, [
                    ...
                    },
                    {
                      ...
                      value: function (t, e) {
                        var i = this._managedNodes.get(t)
                        return i
                          ? (i.removeInertRoot(e), i.destroyed && this._managedNodes.delete(t), i)
                          : null
                      }
                    },
                    {
          ...
          function h(t, e, i) {
            if (t.nodeType == Node.ELEMENT_NODE) {
              ...
              if ('content' == a.localName) {
                for (
                  var n = a, o = n.getDistributedNodes ? n.getDistributedNodes() : [], r = 0;
                  r < o.length;
                  r++
                )
                  h(o[r], e, i)
              ...
              if ('slot' == a.localName) {
                for (
                  var l = a, d = l.assignedNodes ? l.assignedNodes({ flatten: !0 }) : [], c = 0;
                  c < d.length;
                  c++
                )
                  h(d[c], e, i)
  ...
  ;(() => {
    'use strict'
    i.r(a),
      i.d(a, { Timeline: () => Ve, lookupMediaType: () => qe, parseGoogleSpreadsheetURL: () => Kt })
    ...
    function R(t) {
      t = (t = j(t)).toLowerCase()
      for (var e = 'ãàáäâẽèéëêìíïîõòóöôùúüûñç·/_,:;', i = 0, a = e.length; i < a; i++)
    ...
    const U = (t) => {
      ...
      W = (t) =>
        null !== t.w && '' !== t.w
          ...
          : 0
    let Z =
      ((Y = (G = '123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ').length),
      {
        encode: function (t) {
    ...
    const nt = (function () {
      ...
      function k(t, e) {
        ...
        return (
          ...
          (i = t.match(m)) &&
            ((a.skewx = N(i[1], e ? e.skewx : null)), (a.skewy = N(i[3], e ? e.skewy : null))),
          (i = t.match(_)) &&
      ...
      function A(t, e, i, a, s, n, o) {
        if ('transform' == s) {
          for (var l in ((o = {}), i[n][s]))
            o[l] =
              l in a[n][s]
                ? Math.round(((a[n][s][l] - i[n][s][l]) * t + i[n][s][l]) * r) / r
                : i[n][s][l]
          return o
        }
      ...
      function I(t, e) {
        ...
        return D.apply(n, [
          ...
          function (t, a, s) {
            for (i = n.length; i--; )
              for (var o in (c &&
                ((s = S(p[i], t)), (n[i].style.left = s[0] + 'px'), (n[i].style.top = s[1] + 'px')),
              e))
                (a = A(t, _, u, m, o, i)),
                  'transform' == o
                    ? (n[i].style[f] = x(a))
    ...
    class ot {
      ...
      setPosition(t, e) {
        for (var i in t)
          t.hasOwnProperty(i) &&
            (e ? (e.style[i] = t[i] + 'px') : (this._el.container.style[i] = t[i] + 'px'))
      }
      getPosition() {
    ...
    class rt {
      ...
      _momentum() {
        ...
        ;(t.time = 10 * (new Date().getTime() - this.data.time.start)),
          ...
          e.time < 3e3 && (i = !0),
          Math.abs(e.x) > 1e4 &&
            ((this.data.direction = 'left'), e.x > 0 && (this.data.direction = 'right')),
          Math.abs(e.y) > 1e4 &&
            ((this.data.direction = 'up'), e.y > 0 && (this.data.direction = 'down')),
        ...
        addListener: function (t, e, i, a) {
          ...
          if (!t[n]) {
            ...
            if (f && 'dblclick' === e && this.addDoubleTapListener)
              ...
              if ('mousewheel' === e)
                t.addEventListener('DOMMouseScroll', o, !1), t.addEventListener(e, o, !1)
        ...
        return (
          (E.matches = function (t, e) {
            ...
            var a,
              ...
              n = !s
            return (
              n && (s = L).appendChild(t), (a = ~E.qsa(s, e).indexOf(t)), n && L.removeChild(t), a
            )
          }),
          (s = function (t) {
            return t.replace(/-+(.)?/g, function (t, e) {
          ...
          (i.map = function (t, e) {
            var a,
              ...
              o,
              r = []
            if (R(t)) for (s = 0; s < t.length; s++) null != (a = e(t[s], s)) && r.push(a)
    ...
    ;(window.Zepto = dt),
      ...
      (function (t) {
        ...
        function u(t, e, i, a) {
          if ((e = m(e)).ns)
            var s = ((n = e.ns), new RegExp('(?:^| )' + n.replace(' ', ' .* ?') + '(?: |$)'))
          var n
                  ...
                  h &&
                    ...
                    o &&
                      (c = function (e) {
                        ...
                        if (n && n !== s)
                          return (
                            (i = t.extend(x(e), { currentTarget: n, liveFired: s })),
        ...
        ;(t.active = 0),
          ...
          (t.ajax = function (a) {
            ...
            !(function (e) {
              ...
              s.crossDomain ||
                (s.crossDomain =
                  /^([\w-]+:)?\/\/([^\/]+)/.test(s.url) && RegExp.$2 != window.location.host),
            ...
            if ('jsonp' == p || v)
              return (
                v ||
                  (s.url = g(s.url, s.jsonp ? s.jsonp + '=?' : !1 === s.jsonp ? '' : 'callback=?')),
                t.ajaxJSONP(s, n)
              )
            var y,
              b = s.accepts[p],
            ...
            if (
              ...
              (s.contentType ||
                (!1 !== s.contentType && s.data && 'GET' != s.type.toUpperCase())) &&
                  ...
                  if (
                    ...
                    try {
                      'script' == p
                        ...
                        : 'xml' == p
                        ? (e = T.responseXML)
                        : 'json' == p && (e = d.test(e) ? null : t.parseJSON(e))
                    } catch (t) {
                      i = t
                    }
    ...
    const ct = dt.getJSON,
      ...
      yt = it.extend({
        ...
        getDisplayDate: function (t, e) {
          ...
          t || (t = At.fallback),
            t.constructor != At &&
              (S('First argument to getDisplayDate must be type Language'), (t = At.fallback))
        ...
        _setFormat: function (t, e) {
          t
            ...
            e
              ...
              : this.data.format_short || (this.data.format_short = this.findBestFormat(!0))
        },
    ...
    function Pt(t) {
      ...
      if (
        (n ? (s = n.slice(1)) : 1 == (s = t.split(':')).length && (s = t.split('.')), s.length > 4)
      )
    ...
    function Gt(t) {
      return Bt().sanitize(t, { ADD_TAGS: ['iframe'], ADD_ATTR: ['frameborder', 'target'] })
    }
    Bt().addHook('afterSanitizeAttributes', function (t) {
      if ('A' == t.nodeName && 'href' in t) {
        ...
        e
          ? -1 == e.value.indexOf('noopener') && t.setAttribute('rel', `noopener ${e.value}`)
    ...
    class Yt {
      constructor(t) {
        if (
          ...
          if (
            ((this.scale = t.scale), (this.events = []), this._ensureValidScale(t.events), t.title)
          ) {
      ...
      _processDates(t) {
        ...
        if (!(t.start_date instanceof e)) {
          ...
          if (((t.start_date = new e(i)), void 0 !== t.end_date && !(t.end_date instanceof e))) {
            ...
            s
              ? (S('End date same as start date is redundant; dropping end date'),
                delete t.end_date)
              : (t.end_date = new e(a))
          }
        }
      ...
      getEarliestDate() {
        ...
        return this.eras && this.eras.length > 0 && this.eras[0].start_date.isBefore(t)
    ...
    function Jt(t, e) {
      ...
      for (
        s = function (t) {
          return (
            !0 !== r && ('' === t ? (t = null) : !0 === i.skipinitialspace && (t = t.trim())), t
          )
        },
          a = 0;
        a < t.length;
        ...
        (n = t.charAt(a)),
          !1 !== o || (n !== i.delimiter && n !== i.lineterminator)
            ...
            : ((l = s(l)),
              ...
              (r = !1))
      return (
        (l = s(l)), h.push(l), d.push(h), i.skipinitialrows && (d = d.slice(i.skipinitialrows)), d
      )
    }
    function Xt(t) {
      ...
      ;(t = (function (t) {
        ...
        await (async function (t) {
          ...
          .catch((t) => {
            ...
            throw (
              ((e = Array.isArray(t.message) ? t.message.join('<br>') : String(t.message)),
              new x(e))
            )
          })
      ...
      _computePositionInfo(t, e, i) {
        ...
        if (a.length) {
          ...
          for (n = 0; n < a.length; n++)
            l[n] = { label: a[n], idx: n, positions: [], n_rows: 1, n_overlaps: 0 }
          ...
          for (var _ = 0; n < l.length; n++) {
            for (
              this._group_labels.push({ label: l[n].label, rows: l[n].n_rows }), h = 0;
    ...
    class oe {
      ...
      _initLayout() {
        ;(this._el.container = v('div', 'tl-timeera')),
          ...
          this.headline && '' != this.headline && (this._text.innerHTML = q(this.headline)),
          this.onLoaded()
      }
      _initEvents() {}
      _updateDisplay(t, e, i) {
    ...
    class re {
      ...
      _positionTickArray(t, e, i) {
        if (t[1] && t[0]) {
          var a = 1
          e.getPosition(t[1].date.getMillisecond()) - e.getPosition(t[0].date.getMillisecond()) <
              ...
              a > 1
                ? s >= a
                  ...
                  : (s++,
                    ...
                    (o.tick.className = 'tl-timeaxis-tick tl-timeaxis-tick-hidden'))
    ...
    class le {
      ...
      _initLayout() {
        ...
        if (
          ((this._el.date = v('h3', 'tl-headline-date', this._el.headline_container)),
          '' != this.data.text)
        ) {
          var e = ''
          ;(e += (i = 1 == this.options.autolink ? $(this.data.text) : this.data.text).match(
            /<p>[\s\S]*?<\/p>/
          )
            ? i
            : '<p>' + i + '</p>'),
      ...
      loadErrorDisplay(t) {
        ...
        ;(this._el.content_item = v('div', 'tl-media-item tl-media-loaderror', this._el.content)),
          (this._el.content_item.innerHTML =
            "<div class='tl-icon-" + this.options.media_type + "'></div><p>" + t + '</p>'),
          this.onLoaded(!0)
      }
      onLoaded(t) {
        ...
        ;(this._state.show_meta = !0),
          this.data.credit &&
            ...
            (this._el.credit.innerHTML =
              1 == this.options.autolink ? $(this.data.credit) : this.data.credit),
            (this.options.credit_height = this._el.credit.offsetHeight)),
          this.data.caption &&
            '' != this.data.caption &&
            ((this._el.caption = v('div', 'tl-caption', this._el.content_container)),
            (this._el.caption.innerHTML =
              1 == this.options.autolink ? $(this.data.caption) : this.data.caption),
    ...
    class de extends he {
      ...
      createMedia() {
        ...
        ;(this.data.url.match(/.png(\?.*)?$/) || this.data.url.match(/.svg(\?.*)?$/)) &&
          ...
          this.data.alt
            ...
            : this.data.caption && (this._el.content_item.alt = F(this.data.caption)),
          this.data.title
            ? (this._el.content_item.title = this.data.title)
            : this.data.caption && (this._el.content_item.title = F(this.data.caption)),
    ...
    class _e extends he {
      ...
      _updateMediaDisplay() {
        ;(this._el.content_item.style.height = W({ w: this.options.width }) + 'px'),
        ...
        var i = !1,
          ...
          l = {
            ...
            directions: new RegExp(
              s.source + '/dir/' + o.source + '/' + o.source + '/' + n.source + r.source
            ),
      ...
      _loadMedia() {
        ...
        ;(this._el.content_item = this.domCreate(
          ...
          ut({
            ...
            error: function (t, i) {
              var a = ''
              ;(a += e._('wikipedia_load_err') + '<br/>' + e.media_id + '<br/>' + i),
              ...
              let e = (function (t) {
                ...
                if (t.query && t.query.pages) {
                  ...
                  ;(e.url = a.imageinfo[0].thumburl),
                    a.entityterms && a.entityterms.label && (e.label = a.entityterms.label[0])
                }
                return e
              })(t)
              e.url
    ...
    class ke extends he {
      ...
      _updateMediaDisplay() {
        var t = U({ w: this._el.content_item.offsetWidth, h: this.options.height })
        this._el.content_item.style.height = t.h + 'px'
      }
      _stopMedia() {
    ...
    class xe extends he {
      _loadMedia() {
        ...
        ;(t =
          ...
          ut({
            ...
            error: function (t, i) {
              var a = ''
              ;(a += e._('twitter_load_err') + '<br/>' + e.media_id + '<br/>' + i),
                e.loadErrorDisplay(a)
            }
          })
      }
      createMedia(t) {
        ...
        ;(n = t.html.split('</p>&mdash;')[0] + '</p></blockquote>'),
          ...
          (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes(
            'pic.twitter.com'
          )
            ...
            : ((s += n),
              ...
              (s +=
                "<span class='nickname'>@" + e + "<span class='thumbnail-inline'></span></span>"),
              (s += '</a>'),
              (s += '</div>'),
              (s += '</div>'),
      ...
      createMedia(t) {
        ...
        n.includes('pic.twitter.com')
          ? (twttr.ready(function (t) {
              ...
              var e = String(r)
              twttr.widgets
                .createTweet(e, s, { conversation: 'none', linkColor: '#cc0000', theme: 'light' })
                .then(function (t) {
                  this.onLoaded()
                })
            }),
    ...
    class Me extends he {
      ...
      getImageURL(t, e) {
        for (
          var i = this.size_label(e), a = this.sizes[this.sizes.length - 2].source, s = 0;
          s < this.sizes.length;
          s++
        )
    ...
    class Ee extends he {
      _loadMedia() {
        ...
        ;(this._el.content_item = this.domCreate(
          ...
          this.data.url.match(/\.html$/)
            ...
            : this.data.url.match(/.(json|js)$/) || S('DOCUMENT CLOUD IN URL BUT INVALID SUFFIX'),
          ce(
            [
      ...
      createMedia() {
        DV.load(this.data.url, { container: '#' + this._el.content_item.id, showSidebar: !1 }),
          this.onLoaded()
      }
    }
    const Le =
    ...
    class Ae extends he {
      ...
      createMedia() {
        ...
        try {
          ut({ url: t, dataType: 'json', success: De, error: Se, context: this })
        } catch (e) {
    ...
    class Ce extends he {
      _loadMedia() {
        ...
        ;(this._el.content_item = this.domCreate(
          ...
          this.media_id
            ? ((t =
                'https://embed.spotify.com/?uri=' + this.media_id + '&theme=white&view=coverart'),
      ...
      _updateMediaDisplay(t) {
        ...
        ;(e = h
          ...
          : this.options.height - this.options.credit_height - this.options.caption_height - 30),
          ...
          e > this.options.width
            ...
            : (S('width is greater'), S(this.options.width), (i = e + 'px'), (a = e - 80 + 'px')),
    ...
    class ze extends he {
      ...
      createMedia() {
        ...
        ;(this._el.content_item = this.domCreate(
          ...
          (this._el.content_item.innerHTML +=
            "Your browser doesn't support HTML5 audio with " + this._el.source_item.type),
    ...
    function qe(t, e) {
      var i = [
        ...
        { type: 'vimeo', name: 'Vimeo', match_str: '^(https?:)?/*(player.)?vimeo.com', cls: be },
        {
          type: 'dailymotion',
          name: 'DailyMotion',
        ...
        { type: 'vine', name: 'Vine', match_str: '^(https?:)?/*(www.)?vine.co', cls: ke },
        {
          type: 'soundcloud',
          name: 'SoundCloud',
        ...
        { type: 'twitter', name: 'Twitter', match_str: '^(https?:)?/*(www.)?twitter.com', cls: xe },
        {
          type: 'twitterembed',
          name: 'TwitterEmbed',
        ...
        { type: 'flickr', name: 'Flickr', match_str: '^(https?://)?flic.kr/.*', cls: Me },
        {
          type: 'instagram',
          name: 'Instagram',
        ...
        { type: 'pdf', name: 'PDF', match_str: /^.*\.pdf(\?.*)?(\#.*)?/, cls: Re },
        ...
        { type: 'video', name: 'Video', match_str: /(mp4|webm)(\?.*)?$/i, cls: Pe },
        {
          type: 'wistia',
          name: 'Wistia',
        ...
        { type: 'audio', name: 'Audio', match_str: /(mp3|wav|m4a)(\?.*)?$/i, cls: ze },
    ...
    class Fe {
      ...
      getFormattedDate() {
        ...
        return (
          this.data.end_date &&
            (t = ' to ' + this.data.end_date.getDisplayDate(this.getLanguage())),
          this.data.start_date &&
            (t = (t ? 'from ' : '') + this.data.start_date.getDisplayDate(this.getLanguage()) + t),
          t
        )
      }
      _onMarkerClick(t) {
      ...
      _onDragMove(t) {
        ...
        ;(this.data.sliding = !0),
          ...
          this.options.enable.x &&
            ...
            (t.preventDefault(), (this._el.move.style.left = this.data.new_pos.x + 'px')),
          this.options.enable.y &&
            Math.abs(e.y) > Math.abs(e.y) &&
            (t.preventDefault(), (this._el.move.style.top = this.data.new_pos.y + 'px')),
          this.fire('dragmove', this.data)
      }
      _momentum() {
        var t = { x: 0, y: 0, time: 0 },
    ...
    class Be {
      ...
      updateDisplay(t, e, i) {
        ...
        t && (0 == this.options.width && t > 0 && (a = !0), (this.options.width = t)),
          e &&
            ...
            ((this.options.height = e), (this.timescale = this._getTimeScale())),
      ...
      _dispatchVisibleTicksChange() {
        this.ticks_change_timeout &&
          (clearTimeout(this.ticks_change_timeout), (this.ticks_change_timeout = null)),
      ...
      _onMouseScroll(t) {
        ...
        t || (t = window.event),
          ...
          (i = parseInt(this._el.slider.style.left.replace('px', '')) + e) > a.left
            ? (i = a.left)
            : i < a.right && (i = a.right),
          this.animate_css &&
            ((this._el.slider.className = 'tl-timenav-slider'), (this.animate_css = !1)),
      ...
      _initLayout() {
        ;(this._el.line = v('div', 'tl-timenav-line', this._el.container)),
          ...
          (this.timeaxis = new re(this._el.timeaxis, this.options, this.language)),
          (this._swipable = new $e(this._el.slider_background, this._el.slider, {
            enable: { x: !0, y: !1 },
    ...
    class Ue {
      ...
      setActive(t) {
        ;(this.active = t),
          this.active
            ? (this.data.background && this.fire('background_change', this.has.background),
      ...
      getFormattedDate() {
        ...
        return (
          this.has.title ||
            (this.data.end_date &&
              (t = ' &mdash; ' + this.data.end_date.getDisplayDate(this.getLanguage())),
            this.data.start_date &&
              (t = this.data.start_date.getDisplayDate(this.getLanguage()) + t)),
          t
        )
      }
      _initLayout() {
      ...
      _updateBackgroundDisplay() {
        this._background_media &&
          ...
          (this._el.background.style.backgroundImage =
            "url('" +
            this._background_media.getImageURL(this.options.width, this.options.height) +
            "')")
      }
      _setInteractive(t) {
        t
    ...
    class Ze {
      ...
      _findSlideIndex(t) {
        var e = t
        return (
          ('string' == typeof t || t instanceof String) && (e = H(t, this._slides, 'unique_id')), e
        )
      }
      ...
      goTo(t, e, i) {
        ...
        t < this._slides.length &&
          ...
          e
            ? ((this._el.slider_container.style.left = -this.slide_spacing * t + 'px'),
          ...
          this._slides[t + 1]
            ? (this.showNav(this._nav.next, !0), this._nav.next.update(this._slides[t + 1]))
      ...
      preloadSlides(t) {
        this._slides[t + 1] && (this._slides[t + 1].loadMedia(), this._slides[t + 1].scrollToTop()),
          this._slides[t + 2] &&
            (this._slides[t + 2].loadMedia(), this._slides[t + 2].scrollToTop()),
          this._slides[t - 1] &&
      ...
      changeBackground(t) {
        ...
        t.color_value && '' != t.color_value
          ? (e = M(t.color_value)) ||
            (S('Invalid color value ' + t.color_value), (e = this.options.default_bg_color))
      ...
      _initLayout() {
        this._el.container.classList.add('tl-storyslider'),
          ...
          f &&
            ((this._swipable = new $e(this._el.slider_container_mask, this._el.slider_container, {
              enable: { x: !0, y: !1 },
              snap: !0
            })),
            this._swipable.enable(),
      ...
      _onNavigation(t) {
        'next' == t.direction || 'left' == t.direction
          ? this.next()
          : ('previous' != t.direction && 'right' != t.direction) || this.previous(),
        ...
        if (this._loaded) {
          ...
          ;(e = 'mouseenter' === e ? 'mouseover' : 'mouseleave' === e ? 'mouseout' : e),
            this.hasEventListeners(e) &&
              ...
              this.fire(e, { latlng: 'something', layerPoint: 'something else' }))
        }
      }
      _onLoaded() {
        this.fire('loaded', this.data)
    ...
    class Ve {
      constructor(t, e, i) {
        if (
          ...
          a
            ...
            : (delete i.default_bg_color, S('Invalid default background color. Ignoring.'))
        }
        var s, n
        E(this.options, i),
          ...
          i.soundcite &&
            this.on('ready', () => {
              S('Loading Soundcite resources '),
                ue('https://cdn.knightlab.com/libs/soundcite/latest/css/player.css'),
                ce('https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js')
            }),
          this._loadStyles(),
      ...
      _loadStyles() {
        ...
        if (
          this.options.font &&
          (0 == this.options.font.indexOf('http') || this.options.font.match(/\.css$/))
        )
          t = this.options.font
        ...
        if (
          (t && ue(t),
          this.options.theme &&
            (0 == this.options.theme.indexOf('http') || this.options.theme.match(/\.css$/)))
        )
      ...
      setConfig(t) {
        if (
          ((this.config = t),
          this.config.isValid() && (this.config.validate(), this._validateOptions()),
          this.config.isValid())
        )
          try {
      ...
      _updateHashBookmark(t) {
        if (t) {
          ...
          window.history.replaceState(null, 'Browsing TimelineJS', e),
            this.fire(
              'hash_updated',
              { unique_id: this.current_id, hashbookmark: '#event-' + t.toString() },
              this
            )
        }
      }
      ...
      remove(t) {
        if (t >= 0 && t < this.config.events.length) {
          this.config.events[t].unique_id == this.current_id &&
            (t < this.config.events.length - 1 ? this.goTo(t + 1) : this.goTo(t - 1))
